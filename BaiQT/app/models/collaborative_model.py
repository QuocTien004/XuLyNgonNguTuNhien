...
class CollaborativeModel:
    ...
    def _build_model(self):
        ...
        try:
            ...
            if not os.path.exists('D:/HK2_2025/XLNNTN/ProjectXLNNTN/BaiQT/app/data/ratings_processed.csv'):
                raise FileNotFoundError("File ratings_processed.csv not found in app/data/")
            
            # Kiểm tra cấu trúc của file ratings.csv
            ratings_df = pd.read_csv('D:/HK2_2025/XLNNTN/ProjectXLNNTN/BaiQT/app/data/ratings_processed.csv')
